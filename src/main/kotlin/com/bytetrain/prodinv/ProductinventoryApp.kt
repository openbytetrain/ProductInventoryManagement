...
import com.bytetrain.prodinv.config.ApplicationProperties
...
class ProductinventoryApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes productinventory.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<ProductinventoryApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(ProductinventoryApp::class.java)
