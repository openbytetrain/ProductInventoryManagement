...
class OpenApiConfiguration {
    ...
    fun noApiFirstCustomizer() = SwaggerCustomizer { docket -> docket.select()
            .apis(Predicates.not(RequestHandlerSelectors.basePackage("com.bytetrain.prodinv.web.api")))
    }
    ...
    fun apiFirstDocket(jHipsterProperties: JHipsterProperties): Docket {
        ...
        return Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.bytetrain.prodinv.web.api"))
