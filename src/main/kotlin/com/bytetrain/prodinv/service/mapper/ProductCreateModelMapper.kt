...
@Mapper(componentModel = "spring", uses = [CharacteristicModelMapper::class, ProductPriceModelMapper::class, ProductCreateFactory::class, RelatedPlaceRefOrValueModelMapper::class])
