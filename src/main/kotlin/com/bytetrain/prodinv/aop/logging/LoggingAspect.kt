package com.bytetrain.prodinv.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.bytetrain.prodinv.repository..*)" +
            " || within(com.bytetrain.prodinv.service..*)" +
            " || within(com.bytetrain.prodinv.web.rest..*)"
    )
