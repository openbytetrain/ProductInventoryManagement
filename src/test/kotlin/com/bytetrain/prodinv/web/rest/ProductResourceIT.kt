...
class ProductResourceIT {
    ...
    fun createProduct() {
        ...
        assertThat(testProduct.href).isEqualTo(DEFAULT_HREF)
    }
    ...
    fun updateProduct() {
        ...
        updatedProduct.href = UPDATED_HREF
        ...
        val testProduct = productList[productList.size - 1]
        assertThat(testProduct.href).isEqualTo(UPDATED_HREF)
    }
    ...
    companion object {
        ...
        private const val DEFAULT_HREF = "AAAAAAAAAA"
        private const val UPDATED_HREF = "BBBBBBBBBB"
